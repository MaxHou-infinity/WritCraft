...
On 2026-07-30 the unreleased `0.1.2` candidate preparation repeated npm Preview **10/10**, local installed **2/2**, and fresh-tarball installed **2/2** on each of the same official npm 10/arm64 and npm 11/x64 combinations; the production audit reported **0 vulnerabilities**. Its current dry-run package is **119 files / 572,607 bytes packed / 2,623,581 bytes unpacked / shasum `ae4fb9b1a551a71214e0e4e36aebd100f9acd3b8`**. This proves only local candidate packaging and runtime preparation. It is not a real-author journey, registry publication, GitHub Release, or permission to move any dist-tag.
