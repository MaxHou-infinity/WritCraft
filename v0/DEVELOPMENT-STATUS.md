...
> 当前 exact candidate：**`2c6004e fix(image): keep prompts out of manuscripts` 已提交并推送 GitHub `main`。新源码 App 已由该候选启动；下一门禁只复验受影响图片路径。作者签字前不得发布 npm、打 `v0.1.2` 标签或创建 GitHub Release。**
