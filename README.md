...
第一次使用时，先打开 `edit.md`，把“为什么写、写给谁、要讲清什么”告诉笔触。你可以直接进入章节，通过项目对话、段落改写和一致性图谱推进作品。面向空项目的结构方案与已有稿件的写作导航正在为 `0.1.2` 开发，尚未进入当前公开的 `0.1.1` Preview。
...
| 日常写作 | 项目/文件/选区对话、段落改写、Chapter/Research → Changes |
...
`0.1.2` 正在以“结构规划 / 写作导航”替代旧 Plan 任务图。0.0CA 已完成只读 Main/IPC 基础与三种动作交接，但界面、章节骨架事务、真实 Electron 和作者验收仍未完成；因此该能力还不属于上表的当前可用能力。
